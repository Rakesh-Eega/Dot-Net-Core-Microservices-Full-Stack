...
namespace Catalog.Application.Mappers
{
    public static class ProductMapper
    {
        ...
        public static Pagination<ProductResponse> ToResponse(this Pagination<Product> pagination) =>
            new Pagination<ProductResponse>(pagination.PageIndex, pagination.PageSize, pagination.Count,
        ...
        public static Product ToUpdateEntity(this UpdateProductCommand command,Product existing, ProductBrand productBrand, ProductType productType) =>
            new Product
            {
                Id = existing.Id,
                Name = command.Name,
        ...
        public static CreateProductCommand ToCommand(this CreateProductDto product)
        {
